-- @description Tevio - Set render time selection Track format to Video MP4 h264
-- @version 1.0
-- @author Tevio
-- @website http://ottavioscimone.com
-- @changelog
--    + init
-- Based on 'Set render format to Video MP4 MPEG', Author mpl
...
[40]=0
    ...
    local out_str = ''
    GetSetProjectInfo(0, 'RENDER_SETTINGS', 7, true)
    ...
    GetSetProjectInfo_String(0, 'RENDER_FORMAT', 'UE1GRgMAAAAAAAAAAAgAAAMAAACAAAAAgAcAADgEAAAAAPBBAQAAAF8AAAA=', true)
    GetSetProjectInfo_String(0, 'RENDER_PATTERN', 'Video_Selection_$filecount', true)
